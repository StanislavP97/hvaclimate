      ...
      >
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <input
            ...
            className="rounded-xl border border-[#e2e8f0] px-4 py-3 text-sm text-[#0d1b2a] outline-none focus:border-[#2563EB]"
          />
          <input
            required
        ...
        <textarea
          ...
          rows={3}
          className="resize-none rounded-xl border border-[#e2e8f0] px-4 py-3 text-sm text-[#0d1b2a] outline-none focus:border-[#2563EB]"
        />
